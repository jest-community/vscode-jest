...
describe('OutputManager', () => {
  ...
  //   it('should return true when testing setting is "neverOpen"', async () => {
  //     mockWorkspace.getConfiguration.mockReturnValueOnce({
  //       get: jest.fn().mockReturnValueOnce('neverOpen'),
  //     });
  //     const result = await outputManager.validate(false);
  //     expect(result).toBe(true);
  //     expect(showWarningMessage).not.toHaveBeenCalled();
  //   });

  //   it('should return true when revealWithFocus is "test-results"', async () => {
  //     mockWorkspace.getConfiguration.mockReturnValueOnce({
  ...
  //   it('should show warning message when testing setting is not "neverOpen" and revealWithFocus is not "test-results"', async () => {
  //     mockWorkspace.getConfiguration.mockReturnValueOnce({
  //       get: jest.fn().mockReturnValueOnce({
  //         revealOn: 'run',
  //         revealWithFocus: 'terminal',
  ...
  //   it('should show modal warning message when testing setting is not "neverOpen" and revealWithFocus is not "test-results"', async () => {
  //     mockWorkspace.getConfiguration.mockReturnValueOnce({
  //       get: jest.fn().mockReturnValueOnce({
  //         revealOn: 'run',
  //         revealWithFocus: 'terminal',
  ...
  //       }),
  //     });
  //     const result = await outputManager.validate(true);
  //     expect(result).toBe(false);
  //     expect(showWarningMessage).toHaveBeenCalled();
  //   });

  //   it('should return false when user cancels warning message', async () => {
  //     showWarningMessage.mockResolvedValueOnce('Cancel');
  //     const result = await outputManager.validate(true);
  //     expect(result).toBe(false);
  //   });

  //   it('should call showFixChooser when user selects "Fix it" in warning message', async () => {
  //     showWarningMessage.mockResolvedValueOnce('Fix it');
  //     const showFixChooserSpy = jest.spyOn(outputManager, 'showFixChooser');
  //     await outputManager.validate(true);
  //     expect(showFixChooserSpy).toHaveBeenCalled();
  //   });

  //   it('should open output config help when user selects "Help" in warning message', async () => {
  //     showWarningMessage.mockResolvedValueOnce('Help');
  //     const executeCommandSpy = jest.spyOn(vscode.commands, 'executeCommand');
  //     await outputManager.validate(true);
  //     expect(executeCommandSpy).toHaveBeenCalledWith(
  //       'vscode.open',
  //       vscode.Uri.parse(
  //         'https://github.com/jest-community/vscode-jest/blob/main/docs/Output-Configuration.md'
  //       )
  //     );
  //   });
  // });

  // describe('showFixChooser', () => {
  //   let showQuickPick: any;

  //   beforeEach(() => {
  //     showQuickPick = jest.spyOn(vscode.window, 'showQuickPick');
  //   });

  //   it('should return true when user selects "Fix test-results" in quick pick', async () => {
  //     showQuickPick.mockResolvedValueOnce({
  //       label: '$(sync) Fix test-results panel setting',
  //       detail: 'Set "testing.openTesting" to "neverOpen"',
  //     });
  //     const updateTestResultsSettingsSpy = jest.spyOn(outputManager, 'updateTestResultsSettings');
  //     const result = await outputManager.showFixChooser();
  //     expect(result).toBe(true);
  //     expect(updateTestResultsSettingsSpy).toHaveBeenCalled();
  //   });

  //   it('should return true when user selects "Fix outputConfig" in quick pick', async () => {
  //     showQuickPick.mockResolvedValueOnce({
  //       label: '$(sync-ignored) Fix outputConfig setting',
  //       detail: 'Set "jest.outputConfig.revealWithFocus" to "test-results"',
  //     });
  //     const mockWorkspaceUpdateSpy = jest.spyOn(mockWorkspace, 'update');
  //     const result = await outputManager.showFixChooser();
  //     expect(result).toBe(true);
  //     expect(mockWorkspaceUpdateSpy).toHaveBeenCalledWith(
  //       'jest.outputConfig.revealWithFocus',
  //       'test-results',
  //       vscode.ConfigurationTarget.Workspace
  //     );
  //   });
  ...
  //   it('should open workspace settings when user selects "Edit Settings Manually" in quick pick', async () => {
  //     showQuickPick.mockResolvedValueOnce({
  //       label: '$(tools) Edit Settings Manually',
  //       detail: 'Open workspace settings',
  //     });
  //     const executeCommandSpy = jest.spyOn(vscode.commands, 'executeCommand');
  //     await outputManager.showFixChooser();
  //     expect(executeCommandSpy).toHaveBeenCalledWith('workbench.action.openWorkspaceSettings');
  //   });
  // });

  // describe('isTestingSettingValid', () => {
  //   it('should return true when testing setting is "neverOpen"', () => {
  //     mockWorkspace.getConfiguration.mockReturnValueOnce({
  //       get: jest.fn().mockReturnValueOnce('neverOpen'),
  //     });
  //     const result = outputManager.isTestingSettingValid();
  //     expect(result).toBe(true);
  //   });

  //   it('should return true when revealWithFocus is "test-results"', () => {
  //     mockWorkspace.getConfiguration.mockReturnValueOnce({
  //       get: jest.fn().mockReturnValueOnce({
  //         revealOn: 'run',
  //         revealWithFocus: 'test-results',
  ...
  //   it('should return false when testing setting is not "neverOpen" and revealWithFocus is not "test-results"', () => {
  //     mockWorkspace.getConfiguration.mockReturnValueOnce({
  //       get: jest.fn().mockReturnValueOnce({
  //         revealOn: 'run',
  //         revealWithFocus: 'terminal',
